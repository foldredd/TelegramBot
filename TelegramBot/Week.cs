    ...
    class Week
    {
       ...
       public  List<Schedule> scheduleList;
        ...
        public void SendLinks(object state)
        {
            ...
            // установить таймер для следующего дня
            DateTime Today = DateTime.Now;
            DateTime startOfDay = Today.Date;
            long ticksAtStartOfDay = startOfDay.Ticks; // Ticks для начала дня
            DateTime tomorrow = Today.AddDays(1).Date; // Начало дня следующего дня
